    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(debugWindow, SIGNAL(sliderMoved(int)), this, SLOT(handleRpmSlider(int)));
...
void MainWindow::handleRpmSlider(int val)
{
    ui->progressBar->setValue(val);

    /* setup the three gradients for the rpm bar */
    QString value1 = "QProgressBar::chunk {background: QLinearGradient( x1: 0, y1: 0, x2: 1, y2: 0,stop: 0 #00FF00,stop: 0.4999 #76F150,stop: 0.5 #98F150,stop: 1 #AEF150 );}";
    QString value2 = "QProgressBar::chunk {background: QLinearGradient( x1: 0, y1: 0, x2: 1, y2: 0,stop: 0 #00FF00,stop: 0.4999 #76F150,stop: 0.5 #98F150,stop: 1 #F1AE50 );}";
    QString value3 = "QProgressBar::chunk {background: QLinearGradient( x1: 0, y1: 0, x2: 1, y2: 0,stop: 0 #00FF00,stop: 0.4999 #76F150,stop: 0.5 #98F150,stop: 1 #FF0000 );}";
